...
export const articles: Article[] = [
  ...
  },
  {
    ...
    description: "Guía real para el agente ACA licenciado: referidos sistemáticos, WhatsApp, tu propio link de cotización y cómo llegar preparado al 1 de noviembre.",
