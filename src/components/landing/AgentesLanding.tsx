...
import "@/app/agentes/agentes.css";
import PricingSection from "@/app/agentes/PricingSection";
      ...
      <section className="ag-hero">
        ...
        <div className="ag-hero-actions ag-reveal">
          <Link
            ...
            onClick={() => capturePlanCtaClick("pro", "month", "hero")}
          >
        ...
        <Link href="/cotizar" className="ag-hero-link ag-reveal">
          Ver el cotizador que verá tu cliente &rarr;
        </Link>
      </section>
      ...
      <section className="ag-cta-section">
        ...
        <div className="ag-reveal">
          <Link
            ...
            onClick={() => capturePlanCtaClick("pro", "month", "cierre")}
          >
            Crea tu cuenta gratis
            <ArrowIcon />
          </Link>
