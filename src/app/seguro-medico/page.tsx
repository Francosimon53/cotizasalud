    ...
    <div className="es-landing">
      ...
      <nav className="es-nav scrolled">
        <div className="es-nav-inner">
          ...
          <div className="es-nav-links">
            ...
            <Link href="/" className="es-nav-agentes">Para Agentes</Link>
      ...
      <section className="hero">
        ...
        <div className="hero-inner">
          <div>
            <div className="hero-badge"><span className="pulse" /> OEP 2027: Abre Nov 1 · Dic 15 para enero</div>
            ...
            <div className="hero-actions">
              ...
              <Link href="/" className="btn-secondary">🏢 Soy Agente</Link>
            </div>
